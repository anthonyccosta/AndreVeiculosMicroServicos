...
namespace APITermoUso.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class TermoDeUsoesController : ControllerBase
    {
        private readonly APITermoUsoContext _context;

        public TermoDeUsoesController(APITermoUsoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TermoDeUso>> PostTermoDeUso(TermoDeUso termoDeUso)
        {
          if (_context.TermoDeUso == null)
          {
              return Problem("Entity set 'APITermoUsoContext.TermoDeUso'  is null.");
          }
